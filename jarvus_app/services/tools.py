...
from .tool_registry import Tool, ToolParameter, ToolCategory, tool_registry
...
TOOL_DEFS = [
    {
        ...
        "parameters": [
            ToolParameter("max_results", "integer", "Maximum number of emails to return", required=False, default=5),
            ToolParameter("query", "string", "Gmail query syntax for filtering emails", required=False)
        ],
    ...
    },
    {
        ...
        "category": ToolCategory.CUSTOM,
        "parameters": [
            ToolParameter("query", "string", "Gmail query syntax for searching emails"),
            ToolParameter("max_results", "integer", "Maximum number of emails to return", required=False, default=10)
        ],
    ...
    },
    {
        ...
        "parameters": [
            ...
            ToolParameter("bcc", "string", "BCC email address", required=False)
        ],
    ...
    },
    {
        ...
        "parameters": [
            ...
            ToolParameter("time_min", "string", "Start time in ISO 8601 format (e.g., 2024-01-01T00:00:00Z)", required=False),
            ToolParameter("time_max", "string", "End time in ISO 8601 format (e.g., 2024-12-31T23:59:59Z)", required=False)
        ],
    ...
    },
    {
        ...
        "parameters": [
            ...
            ToolParameter("start", "string", "Start time in ISO 8601 format (e.g., 2024-01-24T10:00:00Z)"),
            ToolParameter("end", "string", "End time in ISO 8601 format (e.g., 2024-01-24T11:00:00Z)"),
            ...
            ToolParameter("attendees", "array", "List of attendee email addresses", required=False)
        ],
