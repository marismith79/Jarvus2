...
class Config:
    ...
    AGENT_PLANNING_PROMPT = (
        ...
        "##Examples:\n"
        "\n"
        "User Request: 'Send an email to Alice with the subject \'Project Update\' and attach the latest report.'\n"
        ...
        "    'inputs': [],\n"
        "    'extract': ['file_id'],\n"
        "    'error_handling': 'If the file is not found, add a step to ask the user for the correct file name.'\n"
        "  }},\n"
        "  {{\n"
        "    'instruction': 'If the file name is not known, ask the user to provide the correct file name.',\n"
        "    'tool': 'user_feedback',\n"
        "    'success_criteria': 'User provides the file name.',\n"
        "    'inputs': [],\n"
        "    'extract': ['file_name'],\n"
        "    'error_handling': 'If the user does not respond, remind them once.'\n"
        "  }},\n"
        "  {{\n"
        ...
        "    'inputs': ['file_id'],\n"
        "    'extract': ['email_id'],\n"
        "    'error_handling': 'If sending fails, report the error and retry once.'\n"
        "  }}\n"
        "]\n"
